...
quad_texture = load_texture("/home/melvin/Documents/Python/OpenGL/Attila/textures/cat.png", textures[1])
...
quad_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([-2, 0, 0]))
triangle_pos = pyrr.matrix44.create_from_translation(pyrr.Vector3([-2, 1, -1]))
